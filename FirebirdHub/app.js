...
function renderSports(){
  ...
  function card(g, isResult){
    ...
    const vs = g.opponent ? ((/away/i.test(g.homeAway)?'at ':'vs ')+clubEsc(g.opponent)) : "";
  ...
  let html = '<section aria-labelledby="h-upgames"><div class="sechead"><h2 id="h-upgames" style="font-size:20px">Upcoming '+cap(nounP)+'</h2><span class="rule" aria-hidden="true"></span></div>';
  if(upcoming.length){
