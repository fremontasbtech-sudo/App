...
function renderSports(){
  ...
  function gameCard(g, isResult){
    ...
    const isMeet = /cross country|track|swim|dive|wrestl/i.test(g.sport||"");
    const vs = g.opponent ? (isMeet ? clubEsc(g.opponent) : ((/away/i.test(g.homeAway)?'at ':'vs ')+clubEsc(g.opponent))) : "";
